        ...
        <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-center px-4 py-8 sm:px-8 sm:py-10 lg:p-12">
          <div className="mx-auto w-full max-w-[440px]">
            <header className="mb-8 text-center">
              <h2 className="font-heading text-3xl font-bold text-[#111827]">Join Chromascope</h2>
              <p className="mt-2 text-[15px] text-[#4B5563]">Create your personalized beauty profile</p>
            </header>
            ...
            >
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="pb-4">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-xl border ${errors.email ? 'border-rose-400 bg-rose-50' : 'border-gray-200 bg-gray-50/50'} py-3.5 pl-11 pr-4 text-[15px] text-[#1F2937] placeholder:text-[#9CA3AF] outline-none transition-all focus:border-[#7700CF] focus:bg-white focus:ring-4 focus:ring-[#7700CF]/10`}
                ...
                <div className="pb-4">
                  <label className="mb-1.5 block font-medium text-[14px] text-[#4B5563]">Password</label>
                  <div className="relative flex items-center">
                    <div className="absolute left-4 flex h-full items-center text-[#9CA3AF]">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-2xl border ${errors.password ? 'border-rose-400 bg-rose-50' : 'border-gray-200 bg-gray-50/50'} py-3.5 pl-11 pr-12 font-medium ${!showPassword && formData.password ? 'tracking-widest' : 'tracking-normal'} text-[15px] text-[#1F2937] placeholder:text-[#9CA3AF] outline-none transition-all focus:border-[#7700CF] focus:bg-white focus:ring-4 focus:ring-[#7700CF]/10`}
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <div className="pb-4">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-2xl border ${errors.confirmPassword ? 'border-rose-400 bg-rose-50' : 'border-gray-200 bg-gray-50/50'} py-3.5 pl-11 pr-12 font-medium ${!showConfirmPassword && formData.confirmPassword ? 'tracking-widest' : 'tracking-normal'} text-[15px] text-[#1F2937] placeholder:text-[#9CA3AF] outline-none transition-all focus:border-[#7700CF] focus:bg-white focus:ring-4 focus:ring-[#7700CF]/10`}
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#7700CF] py-4 font-medium text-[15px] text-white shadow-lg shadow-purple-600/20 transition-all hover:bg-[#5C00A3] active:scale-[0.98] disabled:opacity-70"
                >
              ...
              <button
                ...
                disabled={isLoading}
                className="flex w-full items-center justify-center gap-3 rounded-2xl border border-gray-200 bg-white py-3.5 font-medium text-[15px] text-[#374151] shadow-sm transition-all hover:bg-gray-50"
              >
